...
my_list[1] = "Ansari"
my_list[2] = "Ansari2"
# my_list[10] = "Ansari44" # list assignment index out of range
...
my_list.extend([10])
my_list.extend(["Thamim"])
print(my_list)
print(len(my_list))

# insert()
my_list.insert(1, "Ansari")
print(my_list)
print(len(my_list))
